...
- **命名空间**：`ecloud`
- **镜像版本**：`tdengine/tdengine:3.3.6.13`
...
# 输出
docker.io/tdengine/tdengine:3.3.6.13  469.3 MiB  linux/amd64,linux/arm64/v8
```
...
sudo k3s ctr images export tdengine-3.3.6.13.tar docker.io/tdengine/tdengine:3.3.6.13

# 导出单架构版本（仅 amd64，体积更小）
sudo k3s ctr images export --platform linux/amd64 tdengine-3.3.6.13-amd64.tar docker.io/tdengine/tdengine:3.3.6.13
```

**导入镜像（离线部署）**：
```bash
sudo k3s ctr images import tdengine-3.3.6.13.tar
```
